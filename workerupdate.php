...
<head>
    ...
    <title> Worker Details Update</title>
...
<body>
        ...
        <center><h1>Update Worker Details</h1></center>
        ...
        <div class ="container">
            <?php
                ...
                echo "Welcome to Worker Details Update Panel";

                $select="SELECT * FROM gymworker WHERE uid='$u'";
            ...
            ?>
            <form action="perupdateworker.php" method="GET" style="width:50vw; min-width:300px; ">
            <?php
