...
<body>
        ...
        <div class ="container">
            <?php
                ...
                echo "Welcome to Student Details Update Panel";

                $select="SELECT * FROM adduser WHERE uid='$u'";
            ...
            ?>
            <form action="perupdatestudent.php" method="GET" style="width:50vw; min-width:300px; ">
            <?php
            $row= mysqli_fetch_assoc($result)
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <input type="text" class="form-control" name="br" value="<?php echo $row['membership']  ?> ">
