...
<head>
    ...
    <title> Manager Details Update</title>
...
<body>
        ...
        <center><h1>Update Manager Details</h1></center>
        ...
        <div class ="container">
            <?php
                ...
                $select="SELECT * FROM addmanager WHERE uid='$u'";
            ...
            ?>
            <form action="perupdatemanager.php" method="GET" style="width:50vw; min-width:300px; ">
            <?php
